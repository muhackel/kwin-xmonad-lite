...
/**
 * Monocle: jede Zelle ist die ganze um den Aussenabstand verkleinerte Flaeche.
 * Welches Fenster obenauf liegt, entscheidet der Adapter ueber `raiseWindow`.
 */
export function full(area: Rect, count: number, params: LayoutParams): Rect[] {
	...
	for (let i = 0; i < count; i++) {
		...
		// Fenstern zu, ein geteiltes Objekt waere eine stille Falle.
