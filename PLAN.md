...
Stand: 2026-09-06. Der Entwurf mit allen Nutzerentscheidungen steht in Abschnitt 12. Abgeschlossen sind die Meilensteine 0 bis 6 samt den Stabilisierungsschritten 3.1, 3.1.1, 4.1, 4.1.1, 5.1 und den Audits 4.2, 6.1 und 6.2. Aus Meilenstein 6 stehen der modale Dialog als Fokusziel (Fall 20b) und die deklarative Abnahme auf HAL9000 (Fälle 24 bis 24e) noch aus. Das Repo liegt unter `github.com/muhackel/kwin-xmonad-lite`, jeder Meilenstein läuft als Feature-Branch mit `--no-ff`-Merge. Der aktuelle Stand steht in Abschnitt 9.
