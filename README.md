...
> Fenster mit fester Größe bleiben unberührt, Mindest- und Höchstgrößen werden
> berücksichtigt. Der Float-Toggle ist bis zur Shortcut-Integration nur im
> getrennten Dev-Bundle erreichbar. Noch nicht dabei sind die eigenen
> Tastenkürzel (Meilenstein 6) — damit ist bis dahin auch das Full-Layout nicht
> erreichbar. Der vollständige Plan steht in [`PLAN.md`](PLAN.md).
